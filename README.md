...
5. Ubah isi dari variable `$config['base_url']` dengan `http://localhost:8080/`
...
8. Untuk login `admin` kalian bisa menggunakan username = `PGN90` dan password `admin`
9. Untuk login `kasir` kalian bisa menggunakan username = `KSR45` dan password `12345678`
